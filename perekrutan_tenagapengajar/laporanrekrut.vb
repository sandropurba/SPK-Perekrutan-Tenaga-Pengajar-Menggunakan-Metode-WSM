...
Public Class laporanrekrut
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "perekrutan_tenagapengajar.laporanrekrut.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporanrekrut
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporanrekrut = New laporanrekrut
        rpt.Site = Me.Site
        Return rpt
    End Function
